...
enum parameters {ELEMENT_LENGTH,TETHA_CTE,KAPPA_CTE,LAMBDA_CTE,UPSILON_CTE,FI_CTE,ALFA_CTE,DELTA_CTE,NU_CTE};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,float lambda,float u,float fi,float alfa,float delta,float n){
            ...
            parameters[TETHA_CTE]=t;
            parameters[KAPPA_CTE]=k;
            parameters[LAMBDA_CTE]=lambda;
            parameters[UPSILON_CTE]=u;
